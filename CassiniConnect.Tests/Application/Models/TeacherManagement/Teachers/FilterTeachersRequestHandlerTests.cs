...
{
    public class FilterTeachersRequestHandlerTests
    {
        private readonly DataContext dataContext;
        private readonly FilterTeachers.FilterTeachersRequestHandler handler;

        public FilterTeachersRequestHandlerTests()
        {
            var options = new DbContextOptionsBuilder<DataContext>()
                .UseInMemoryDatabase(databaseName: "TestDb")
                .Options;
            dataContext = new DataContext(options);
            handler = new FilterTeachers.FilterTeachersRequestHandler(dataContext);
        }
        ...
        {
            var command = new FilterTeachers.FilterTeachersRequest { LanguageCode = "fr", NameSearch = "Alice" };
